    ...
    contracts: [
        {
            ...
            config: {
                // Standard OApp configuration
                delegate: ethereumContract.address,
                
                // Read channel configuration with higher gas limits
                readChannelConfigs: [
                    {
                        ...
                        ulnConfig: {
                            ...
                            requiredDVNs: [
                                "0xdb979d0a36af0525afa60fc265b1525505c55d79", // LayerZero DVN
                                "0xf4064220871e3b94ca6ab3b0cee8e29178bf47de"  // Nethermind DVN
                            ],
                            optionalDVNs: [],
                        ...
                        enforcedOptions: [
                            {
                                ...
                                gas: 3000000, // Increased gas significantly
                                value: 0,
                                size: 128    // Increased size for more data
                            }
                        ]
                    }
                ],
                
                // Enforced options for standard messages
                enforcedOptions: [
                    {
                        eid: EndpointId.SONIC_V2_MAINNET,
                        msgType: 1,
                        options: "0x000301001505000000000000000000000000002dc6c000000080" // 3M gas, 128 bytes
                    }
                ]
            }
        },

        {
            ...
            config: {
                // Standard OApp configuration
                delegate: sonicContract.address,
                ...
                readChannelConfigs: [
                    {
                        ...
                        ulnConfig: {
                            ...
                            requiredDVNs: [
                                "0x78f607fc38e071ceb8630b7b12c358ee01c31e96", // LayerZero DVN
                                "0x3b0531eb02ab4ad72e7a531180beef9493a00dd2"  // Nethermind DVN
                            ],
                            optionalDVNs: [],
                            optionalDVNThreshold: 0
                        },
    ...
    connections: [
        {
            ...
            config: {
                ...
                sendConfig: {
                    ...
                    ulnConfig: {
                        confirmations: 15, // Reduced for faster confirmation
                        requiredDVNs: [
